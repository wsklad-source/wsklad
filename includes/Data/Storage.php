...
class Storage implements StorageInterface
{
	...
	public function __construct($object_type)
	{
		...
		// hook
		$this->set_storages(apply_filters(WSKLAD_PREFIX . 'data_storages', $this->get_storages()));
		...
		// hook
		$storage = apply_filters(WSKLAD_PREFIX . 'data_storages_' . $object_type, $this->storages[$object_type]);
