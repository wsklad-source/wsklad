...
abstract class Form
{
	...
	{
		$saved_data = apply_filters(WSKLAD_PREFIX . $this->get_id() . '_form_load_saved_data', $saved_data);
	...
	{
		$fields = apply_filters(WSKLAD_PREFIX . $this->get_id() . '_form_load_fields', $fields);
	...
	{
		return WSKLAD_PREFIX . $this->get_id() . '_form_field_' . $key;
	}
	...
	public function generate_title_html($key, $data)
	{
		...
		<div class="wsklad-title-wrap">
			<h3 class="wc-settings-sub-title <?php echo esc_attr($data['class']); ?>" id="<?php echo esc_attr($field_key); ?>"><?php echo wp_kses_post($data['title']); ?></h3>
			<?php if (!empty($data['description'])) : ?>
				<p><?php echo wp_kses_post($data['description']); ?></p>
			<?php endif; ?>
		</div><table class="form-table wsklad-form-table">
		<?php
