...
trait Sections
{
	...
	public function initSections($sections = [])
	{
		...
		$final = apply_filters(WSKLAD_ADMIN_PREFIX. 'init_sections', $default_sections);
	...
	{
		return apply_filters(WSKLAD_ADMIN_PREFIX. 'get_sections', $this->sections);
	}
	...
	{
		// hook
		$sections = apply_filters(WSKLAD_ADMIN_PREFIX. 'set_sections', $sections);
