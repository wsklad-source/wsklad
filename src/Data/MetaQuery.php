...
class MetaQuery
{
	...
	{
		return wsklad()->database()->base_prefix . 'wsklad_' . $type . 's_meta';
	}
	...
	protected function find_compatible_table_alias($clause, $parent_query)
	{
		 ...
		 */
		return apply_filters('wsklad_data_meta_query_find_compatible_table_alias', $alias, $clause, $parent_query, $this);
	}
