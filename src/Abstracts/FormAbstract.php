...
abstract class FormAbstract
{
	...
	{
		$saved_data = apply_filters('wsklad_' . $this->get_id() . '_form_load_saved_data', $saved_data);
	...
	{
		$fields = apply_filters('wsklad_' . $this->get_id() . '_form_load_fields', $fields);
	...
	{
		return 'wsklad_' . $this->get_id() . '_form_field_' . $key;
	}
