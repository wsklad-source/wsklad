...
abstract class WizardAbstract
{
	...
	{
		$this->steps = apply_filters('wsklad_wizards_steps', $steps, $this->getId());
	}
	...
	public function route()
	{
		...
		{
			add_action('wsklad_wizard_content_output', [$this, 'error']);
		}
		else
		{
		...
		wsklad()->views()->getView('wizards/page.php', $args);
	}
	...
	{
		wsklad()->views()->getView('wizards/error.php');
	}
}